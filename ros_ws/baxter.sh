...
your_ip="158.121.119.27"
#your_hostname="my_computer.local"

#Direct Connect IP
#set this to be the IPV4 address of the machine you are typing on
#1) Disable Networking
#2) Check no IP address for eth0: ifconfig eth0
#3) Run sudo avahi-autoipd eth0 -> use the bound IP address
#ROS_IP="169.254.53.167"
